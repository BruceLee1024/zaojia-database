...
import { exportQuotaTemplate } from '../data/excel.js?v=6.12';
import { hasMissingPrice, quotaPriceStatus } from '../utils/costing.js?v=6.12';
import { BREAKDOWN_KEYS, compositionPanelShell, normalizeBreakdown, parseQuotaBreakdownInputValues } from './quotaResourceComposition.js?v=6.12';
import { mountQuotaResourceComposition } from './quotaResourceCompositionPanel.js?v=6.12';
