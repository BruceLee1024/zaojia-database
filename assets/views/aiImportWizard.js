...
import { parseImportFile } from '../data/excel.js?v=6.10';
import { buildHeaderTree, classifyImportRow, detectImportRegions } from '../data/importEngine.js?v=6.10';
import { buildImportColumnMapping } from '../services/importMappingService.js?v=6.10';
import { getImportSchema } from '../services/importSchemaService.js?v=6.10';
import { recognizeImportColumns } from '../services/aiImportRecognitionService.js?v=6.10';
import { analyzeImport, commitImport } from '../services/importWorkflowService.js?v=6.10';
import { listMappingTemplates, markMappingTemplateUsed, saveMappingTemplate } from '../services/importMappingTemplateService.js?v=6.10';
import { projectRepo } from '../data/repository.js?v=6.10';
