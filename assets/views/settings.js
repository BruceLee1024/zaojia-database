// 视图：数据与备份
import { AI_SYSTEM_PROMPT_PRESETS, getAIConfig, getAISystemPromptPreset, setAIConfig, listProviders, getProviderDefaults } from '../services/aiService.js?v=6.3';
import { generateSystemPromptDraft } from '../services/aiPromptService.js?v=6.3';
import { testAIConnection } from '../services/aiAssistService.js?v=6.3';
...
import { STORES, dbGetAll } from '../data/repository.js?v=6.3';
import { activateLocalFolderStorage, getStorageStatus, reconnectLocalFolderStorage, setDataProfile, storageGetAttachment, storageGetCache, storageRemoveAttachment, storageSetAttachment, storageSetStrict, switchToBrowserStorage, syncBrowserCacheToLocalFolder, withFolderMirrorSuspended } from '../data/storage.js?v=6.3';
import { clearBackupData, createLegacyJsonBackup, createZipBackup, parseLegacyJsonBackupFile, restoreLegacyJsonBackup, restoreZipBackup } from '../services/backupService.js?v=6.3';
import { ensureDemoData, removeDemoData } from '../data/demo.js?v=6.3';
import { esc, toast, fmt, scopedDom } from '../utils/dom.js?v=6.3';
