...
import { suggestLibraryItem } from '../services/aiAssistService.js?v=6.10';
import { projectRepo, quotaRepo } from '../data/repository.js?v=6.10';
import { exportBoqLibraryTemplate } from '../data/excel.js?v=6.10';
import { esc, openModal, closeModal, toast, scopedDom } from '../utils/dom.js?v=6.10';
import { ICONS } from '../utils/icons.js?v=6.10';
