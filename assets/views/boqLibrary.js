...
import { suggestLibraryItem } from '../services/aiAssistService.js?v=6.9';
import { projectRepo, quotaRepo } from '../data/repository.js?v=6.9';
import { exportBoqLibraryTemplate } from '../data/excel.js?v=6.9';
import { esc, openModal, closeModal, toast, scopedDom } from '../utils/dom.js?v=6.9';
import { ICONS } from '../utils/icons.js?v=6.9';
