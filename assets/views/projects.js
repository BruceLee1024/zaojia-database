...
import { boqRepo, versionRepo } from '../data/repository.js?v=6.8';
import { fmt, fmtMoney, esc, openModal, closeModal, toast, scopedDom } from '../utils/dom.js?v=6.8';
...
import { suggestProjectInfo } from '../services/aiAssistService.js?v=6.8';
import { CURRENCY_OPTIONS, currencyLabel, normalizeCurrency } from '../utils/currency.js?v=6.8';
