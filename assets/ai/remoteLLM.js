...
import { quotaRepo, projectRepo, indicatorRepo, boqRepo, versionRepo, experienceCardRepo } from '../data/repository.js?v=6.15';
import { categoryGuess } from '../utils/stats.js?v=6.15';
import { hasMissingPrice } from '../utils/costing.js?v=6.15';
import { sanitizeRemoteContext } from '../services/aiTaskService.js?v=6.15';
