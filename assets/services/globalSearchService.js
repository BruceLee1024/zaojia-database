...
import { quotaRepo, boqLibraryRepo, projectRepo, boqRepo, versionRepo, indicatorRepo, experienceCardRepo, resourceRepo } from '../data/repository.js?v=6.10';
import { fmtMoney } from '../utils/dom.js?v=6.10';
