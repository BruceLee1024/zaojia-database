...
import { boqRepo, projectBoqQuotaRelationRepo, projectRepo, versionRepo } from '../data/repository.js?v=6.7';
...
import { groupForLine } from './boqService.js?v=6.7';
import { assertProjectEditableById } from './projectLockService.js?v=6.7';
