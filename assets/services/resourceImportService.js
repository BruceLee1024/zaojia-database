import { resourcePriceRepo, resourceRepo } from '../data/repository.js?v=6.8';
import { resourceCodeIdentity, resourceCompositeIdentity, validateResourceCollection } from './resourceService.js?v=6.8';
