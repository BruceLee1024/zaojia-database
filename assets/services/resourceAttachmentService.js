import { resourceAttachmentRepo, resourcePriceRepo, resourceRepo } from '../data/repository.js?v=6.10';
import { storageGetAttachment, storageRemoveAttachment, storageSetAttachment } from '../data/storage.js?v=6.10';
