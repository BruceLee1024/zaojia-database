...
const SCHEMAS = {
  ...
  project_boq: schema('project_boq', '项目工程量清单', [
    ...
    field('feature', '项目特征', ['项目特征', '项目特征描述', '特征描述', '清单描述', '特征'], 'text'),
    field('unit', '单位', COMMON_UNIT, 'unit', true),
    ...
    field('laborAmount', '其中人工费', ['定额人工费', '其中人工费', '人工费'], 'money', false, { positiveContext: ['其中', '定额'], negativeContext: ['单价'] }),
    field('machineAmount', '其中机械费', ['定额机械费', '其中机械费', '机械费'], 'money', false, { positiveContext: ['其中', '定额'], negativeContext: ['单价'] }),
    field('provisionalAmount', '暂估价', ['暂估价', '专业工程暂估价'], 'money'),
