import { quotaRepo, quotaResourceUsageRepo, resourcePriceRepo, resourceRepo } from '../data/repository.js?v=6.5';
import { uid } from '../utils/dom.js?v=6.5';
import { resourcePriceService } from './resourcePriceService.js?v=6.5';
