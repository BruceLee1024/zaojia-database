// 应用入口：路由 + 启动
import * as dashboard from './assets/views/dashboard.js?v=2.8';
import * as quota     from './assets/views/quota.js?v=2.8';
import * as projects  from './assets/views/projects.js?v=2.8';
import * as boq       from './assets/views/boq.js?v=2.8';
import * as indicators from './assets/views/indicators.js?v=2.8';
import * as settings  from './assets/views/settings.js?v=2.8';
import * as ai        from './assets/views/ai.js?v=2.8';
...
function exportAll() {
  // 复用 settings 的导出逻辑
  import('./assets/views/settings.js?v=2.8').then(m => m.render());
  // 简化：直接跳到设置页
