// 应用入口：路由 + 启动
import * as dashboard from './assets/views/dashboard.js?v=6.5';
import * as importer  from './assets/views/importer.js?v=6.5';
import * as quota     from './assets/views/quota.js?v=6.5';
import * as projects  from './assets/views/projects.js?v=6.5';
import * as boq       from './assets/views/boq.js?v=6.5';
import * as indicators from './assets/views/indicators.js?v=6.5';
import * as experience from './assets/views/experience.js?v=6.5';
import * as settings  from './assets/views/settings.js?v=6.5';
import * as ai        from './assets/views/ai.js?v=6.5';
import * as resources from './assets/views/resources.js?v=6.5';
import { searchAll, searchGroups } from './assets/services/globalSearchService.js?v=6.5';
import { smartSearch } from './assets/services/aiAssistService.js?v=6.5';
import { getStorageStatus } from './assets/data/storage.js?v=6.5';
import { openModal, closeModal, esc } from './assets/utils/dom.js?v=6.5';
import { ICONS } from './assets/utils/icons.js?v=6.5';
import { navigationItemHtml } from './assets/views/navigation.js?v=6.5';
import { createLatestCoordinator, createLatestWorkspaceCoordinator, createWorkspaceRoot } from './assets/utils/requestCoordinator.js?v=6.5';
...
const renderers = {
  ...
  'resource-import': {
    render: async workspace => {
      const module = await import('./assets/views/resourceImport.js?v=6.5');
      return module.render(workspace);
    },
  },
  'boq-library': {
    render: async workspace => {
      const module = await import('./assets/views/boqLibrary.js?v=6.5');
      return module.render(workspace);
    },
  },
  'ai-import': {
    render: async workspace => {
      const module = await import('./assets/views/aiImportWizard.js?v=6.5');
      return module.render(workspace);
    },
  },
};
...
function exportAll() {
  import('./assets/views/settings.js?v=6.5').then(m => m.triggerExportBackup());
  go('settings');
}
