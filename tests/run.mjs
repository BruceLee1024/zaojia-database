...
import { calculateAmount, hasMissingPrice } from '../assets/utils/costing.js?v=6.6';
import { formatCurrency, normalizeCurrency, sumByCurrency } from '../assets/utils/currency.js?v=6.6';
import { decodeCsvBuffer, detectCombinedNameFeatureMeta, detectRowKind, parseImportFile, rowToBOQ, rowToQuotaItem, rowsFromSheetMatrix, summarizeSheetMatrices } from '../assets/data/excel.js?v=6.6';
import { buildHeaderTree, detectImportRegions, expandMergedHeaderGrid } from '../assets/data/importEngine.js?v=6.6';
import { applyMappingTemplate, buildImportColumnMapping, buildImportMapping, matchMappingTemplate, resolveImportPricing } from '../assets/services/importMappingService.js?v=6.6';
import { getImportSchema, normalizeImportDate, normalizeImportNumber } from '../assets/services/importSchemaService.js?v=6.6';
import { analyzeImport, mergeCommitRows } from '../assets/services/importWorkflowService.js?v=6.6';
import { createMappingTemplate, deleteMappingTemplate, listMappingTemplates, saveMappingTemplate } from '../assets/services/importMappingTemplateService.js?v=6.6';
import { findDuplicateLibraryItem, normalizeLibraryItem } from '../assets/services/boqLibraryService.js?v=6.6';
import { createHierarchicalRecognitionRequest, createRecognitionRequest, validateColumnRecognitionPayload, validateRecognitionPayload } from '../assets/services/aiImportRecognitionService.js?v=6.6';
import { applyHierarchicalTemplate, getImportBlockingReasons, normalizeWizardStep, splitImportedNameFeature } from '../assets/views/aiImportWizard.js?v=6.6';
import { normalizeHubImportResult } from '../assets/views/importer.js?v=6.6';
import { applyLibraryAISuggestions, buildLibraryEditPayload, buildLibraryMetricCards, getLibraryDetailSummary } from '../assets/views/boqLibrary.js?v=6.6';
import { ICONS, ICON_TONES, getIcon } from '../assets/utils/icons.js?v=6.6';
import { AI_SYSTEM_PROMPT_PRESETS, DEFAULT_AI_SYSTEM_PROMPT, getAIConfig, getAISystemPromptPreset, restoreBackupSafeAIConfig, toBackupSafeAIConfig } from '../assets/services/aiService.js?v=6.6';
import { buildSystemPromptGenerationMessages, parseSystemPromptDraft } from '../assets/services/aiPromptService.js?v=6.6';
...
async function testBoqLibraryService() {
  ...
  const repo = await import('../assets/data/repository.js?v=6.6');
