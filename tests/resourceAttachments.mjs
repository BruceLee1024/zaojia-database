...
import { resourceAttachmentRepo, resourcePriceRepo, resourceRepo } from '../assets/data/repository.js?v=6.10';
import { storageGet, storageGetAttachment, storageRemoveAttachment, storageSetAttachment, storageSetStrict, writeStoresToDirectory } from '../assets/data/storage.js?v=6.10';
import { restoreLegacyJsonBackup } from '../assets/services/backupService.js?v=6.10';
import { resourceAttachmentService } from '../assets/services/resourceAttachmentService.js?v=6.10';
import { attachmentListHtml, attachmentPanelShell, loadAttachmentPanel, shouldDownloadAttachment } from '../assets/views/resourceAttachments.js?v=6.10';
