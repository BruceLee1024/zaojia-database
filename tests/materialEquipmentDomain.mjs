...
import { STORES, resourceRepo, resourcePriceRepo, quotaResourceUsageRepo, resourceAttachmentRepo } from '../assets/data/repository.js?v=6.12';
import { resourceService, resourceIdentity } from '../assets/services/resourceService.js?v=6.12';
import { resourcePriceService } from '../assets/services/resourcePriceService.js?v=6.12';
